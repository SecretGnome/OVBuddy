...
echo ""
echo "Boot order:"
echo "  1. fix-bonjour → ensures avahi-daemon starts"
echo "  2. ovbuddy-wifi → monitors WiFi and provides AP fallback"
echo "  3. ovbuddy → updates e-ink display"
echo "  4. ovbuddy-web → provides web interface"
echo ""
